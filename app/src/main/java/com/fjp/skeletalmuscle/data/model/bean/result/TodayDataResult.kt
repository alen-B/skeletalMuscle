...
@Parcelize
data class SportLiftLeg(val sport_time: Long = 0, val avg_left_degree: Int = 0, val avg_rate_value: Int = 0, val avg_right_degree: Int = 0, val calorie: List<Calorie> = listOf(), val cardiorespiratory_endurance: Double = 0.0, val efficient_grease_burning: Int = 0, val extreme_breakthrough: Int = 0, val heart_lung_enhancement: Int = 0, val heart_rate: List<HeartRate> = listOf(), val id: Int = 0, val left_times: Long = 0, val max_rate_value: Int = 0, val min_rate_value: Int = 0, val record: List<TodayRecord> = listOf(), val right_times: Int = 0, val score: Int = 0, val sum_calorie: Int = 0, val user_id: Int = 0, val warm_up_activation: Int = 0) : Parcelable
