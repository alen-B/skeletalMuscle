package com.fjp.skeletalmuscle.view.calendar;
...
public class SMWeekBar extends WeekBar {

    private int mPreSelectedIndex;

    public SMWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.cv_week_bar, this, true);
        setBackgroundResource(R.drawable.bg_gray_round_15);
