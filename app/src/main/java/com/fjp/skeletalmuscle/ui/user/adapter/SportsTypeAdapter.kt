...
class SportsTypeAdapter(data: ArrayList<Sports>, var clickItem: (item: Sports) -> Unit) : BaseQuickAdapter<Sports, BaseViewHolder>(R.layout.item_assessment_type, data) {
    init {
