...
class AssessmentTypeAdapter(data: ArrayList<String>, var defaultIndex: Int, var clickItem: (item: String, position: Int) -> Unit) : BaseQuickAdapter<String, BaseViewHolder>(R.layout.item_assessment_type, data) {
    init {
