...
class SportsAssessmentsHistoryActivity : BaseActivity<SportsAssessmentsHistoryViewModel,ActivitySportsAssessmentsHistoryBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        val fragments =arrayListOf<Fragment>(AssessmentResultFragment.newInstance(1),
            AssessmentResultFragment.newInstance(2),
            AssessmentResultFragment.newInstance(3),
            AssessmentResultFragment.newInstance(4),
            AssessmentResultFragment.newInstance(5),
            AssessmentResultFragment.newInstance(6),
            AssessmentResultFragment.newInstance(7),
            AssessmentResultFragment.newInstance(8),
            AssessmentResultFragment.newInstance(9),
            AssessmentResultFragment.newInstance(10),
            AssessmentResultFragment.newInstance(11),
            AssessmentResultFragment.newInstance(12)
            )
