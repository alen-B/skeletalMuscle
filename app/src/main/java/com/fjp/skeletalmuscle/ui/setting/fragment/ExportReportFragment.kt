...
//
            ...
            allSportstable.addCell(PDFManager.createCellAndBackground(Text("平均得分 ").setFontSize(10f).setFontColor(ColorConstants.GRAY), Text(it.score.toString() + " 分").setFontSize(11f).setFontColor(DeviceRgb(30, 157, 144)), cellBackGround = DeviceRgb(244, 249, 255), isFirst = true, isLast = false).setMarginLeft(40f))
            allSportstable.addCell(PDFManager.createCellAndBackground(Text("运动时长 ").setFontSize(10f).setFontColor(ColorConstants.GRAY), Text(DateTimeUtil.formatExportTime(it.sport_time.toLong())).setFontSize(11f).setFontColor(ColorConstants.BLACK), cellBackGround = DeviceRgb(244, 249, 255), isFirst = false, isLast = false))
            allSportstable.addCell(PDFManager.createCellAndBackground(Text("消耗卡路里 ").setFontSize(10f).setFontColor(ColorConstants.GRAY), Text("${(it.calorie_total / 1000f).toInt()} 千卡").setFontSize(11f).setFontColor(ColorConstants.BLACK), cellBackGround = DeviceRgb(244, 249, 255), isFirst = false, isLast = false))
            allSportstable.addCell(PDFManager.createCellAndBackground(Text("平均心率 ").setFontSize(10f).setFontColor(ColorConstants.GRAY), Text(it.avg_rate_value.toString()+" bpm").setFontColor(ColorConstants.BLACK).setFontSize(11f), cellBackGround = DeviceRgb(244, 249, 255), isFirst = false, isLast = true))
...
//                highLegTab.addHeaderCell(PDFManager.createCell("平均得分"))
                ...
                highLegTab.addHeaderCell(PDFManager.createCell("运动总量", color = ColorConstants.GRAY, textAligment = TextAlignment.LEFT).setWidth(80f))
                highLegTab.addHeaderCell(PDFManager.createCell("左腿运动次数", color = ColorConstants.GRAY, textAligment = TextAlignment.LEFT).setWidth(80f))
                highLegTab.addHeaderCell(PDFManager.createCell("右腿运动次数", color = ColorConstants.GRAY, textAligment = TextAlignment.LEFT).setWidth(80f))
...
//                highLegTab.addCell(PDFManager.createCell(it.sport_lift_leg.score.toString()))
                ...
                highLegTab.addCell(PDFManager.createCell("${it.sport_lift_leg.left_sport_amount} 次°", textAligment = TextAlignment.LEFT).setWidth(80f))
